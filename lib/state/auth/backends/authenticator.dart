...
import 'package:instagram_app_clone/state/auth/constants/constants.dart';
...
class Authenticator {
  ...
  Future<AuthResult> loginWithFacebook() async {
    ...
    try {
      ...
      if (e.code == Constants.accountsExistWithDifferentCredential && email != null && credential != null) {
